...
def start(data_url = 'http://download.tensorflow.org/data/speech_commands_v0.02.tar.gz',
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default=None, #'http://download.tensorflow.org/data/speech_commands_v0.02.tar.gz',
